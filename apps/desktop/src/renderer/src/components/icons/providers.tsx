/*
 * Provider / vendor logos, ported as self-contained inline SVGs from the
 * Trifecta desktop icon set (apps/web/src/components/Icons.tsx). These are the
...
/** OpenAI (Codex) — inherits `currentColor`. */
export function OpenAIIcon({ size = 16, className }: ProviderIconProps): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
